...
//        $I->runShellCommand("docker exec phantom_web git clone https://github.com/ChanakaR/php-simple.git /var/www/html/php-simple");
...
//        $I->runShellCommand('docker exec phantom_web rm -rf /var/www/html/php-simple');
//    }
//
...
//        $I->runShellCommand("docker exec phantom_web php /var/www/html/php-simple/app.php");
...
//        $I->amOnPage('http://localhost:6768');
